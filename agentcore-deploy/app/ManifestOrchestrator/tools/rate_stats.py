...
See manifest_agents.tools.rate_stats in the main agents/ package for the full
writeup. Duplicated here (not imported) because this AgentCore deployment
package ships standalone.
"""
...
_RATE_HISTORY_PATH = Path(__file__).resolve().parent.parent / "seed-data" / "rate-history.json"
_MARKET_CONDITIONS_PATH = Path(__file__).resolve().parent.parent / "seed-data" / "market-conditions.json"
